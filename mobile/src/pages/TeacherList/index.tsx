...
function TeacherList() {
  ...
  function handleDisplayFiltersToggle() {
  ...
  async function loadFavorites() {
    AsyncStorage.getItem('favorites').then(response => {
      if (response) {
        ...
        const favoritesIds = favoritesList.map((favorite: Teacher) => favorite.id)
        setFavoriteTeachers(favoritesIds);
      }
    })
  }
  ...
  return (
    <View style={styles.container}>
      <PageHeader
        ...
        headerRight={(
          <BorderlessButton onPress={handleDisplayFiltersToggle}>
